...
export const RAW_MODELS = [
  ...
  [
    ...
    true,
    87,
    "Compact 2B foundational multilingual LLM natively optimized for 10 Indian languages and high token efficiency.",
    [
      "llm",
      "india",
      "sarvam",
  ...
  [
    ...
    false,
    88,
    "State-of-the-art expressive Text-to-Speech (TTS) engine for Hindi, Tamil, Telugu, Bengali, Kannada, and Marathi.",
    [
      "audio",
      "tts",
      "india",
  ...
  [
    ...
    false,
    89,
    "High-precision Automatic Speech Recognition (ASR) model delivering ultra-low Word Error Rate across 10 Indian languages.",
    [
      "audio",
      "asr",
      "india",
  ...
  [
    ...
    true,
    83,
    "First open-source foundational Hindi language model with custom tokenization built upon LLaMA 2 7B.",
    [
      "llm",
      "india",
      "sarvam",
  ...
  [
    ...
    false,
    86,
    "India's first full-stack indigenous foundation model trained on over 2 trillion tokens across 22 Indian languages.",
    [
      "llm",
      "india",
      "krutrim",
  ...
  [
    ...
    false,
    89,
    "Advanced multimodal Indic LLM designed for complex multi-step reasoning, vision analysis, and bilingual coding.",
    [
      "multi",
      "llm",
      "india",
  ...
  [
    ...
    false,
    85,
    "Indigenous multimodal conversational AI supporting 14+ Indian languages with voice, text, and video capabilities.",
    [
      "multi",
      "llm",
      "india",
  ...
  [
    ...
    true,
    91,
    "State-of-the-art neural machine translation model by IIT Madras covering all 22 scheduled Indian languages and English.",
    [
      "llm",
      "translation",
      "india",
  ...
  [
    ...
    true,
    85,
    "Instruction-tuned Hindi foundation model aligned on high-quality Indic human feedback and cultural knowledge.",
    [
      "llm",
      "hindi",
      "india",
  ...
  [
    ...
    true,
    82,
    "Lightweight multilingual ALBERT-based masked language model evaluated on 12 major Indian languages.",
    [
      "llm",
      "encoder",
      "india",
  ...
  [
    ...
    true,
    89,
    "Benchmark speech-to-text recognition model fine-tuned across 22 Indian languages with extreme dialect robustness.",
    [
      "audio",
      "asr",
      "india",
  ...
  [
    ...
    true,
    86,
    "Multilingual Indic foundational model built in collaboration with IIT Bombay supporting 11+ Indian languages for healthcare and governance.",
    [
      "llm",
      "india",
      "hanooman",
  ...
  [
    ...
    false,
    90,
    "Enterprise-scale multimodal Indic foundation model for high-throughput multilingual document synthesis and public administration.",
    [
      "multi",
      "llm",
      "india",
  ...
  [
    ...
    false,
    91,
    "Dual-transformer multilingual model architecture by Pranav Mistry delivering native understanding across 50+ languages with minimal token bloat.",
    [
      "llm",
      "india",
      "twoai",
  ...
  [
    ...
    true,
    87,
    "Ultra-fast, cost-effective 8B multilingual model optimized for low-latency edge deployment and Indian language dialogue.",
    [
      "llm",
      "india",
      "twoai",
  ...
  [
    ...
    true,
    86,
    "Foundational LLM engineered specifically for Hindi dialects (Bhojpuri, Maithili, Awadhi) and regional language revitalization.",
    [
      "llm",
      "india",
      "techmahindra",
  ...
  [
    ...
    true,
    85,
    "Instruction-tuned foundational model supporting 15 Indian languages across Hindi, Telugu, Tamil, Malayalam, and Kannada.",
    [
      "llm",
      "india",
      "navarasa",
  ...
  [
    ...
    true,
    83,
    "Expanded vocabulary and tokenization framework tailored for Tamil text generation built on top of LLaMA architecture.",
    [
      "llm",
      "tamil",
      "india",
  ...
  [
    ...
    true,
    83,
    "Foundational instruction-tuned LLM tailored for high-quality Kannada text processing with extended native token vocabulary.",
    [
      "llm",
      "kannada",
      "india",
  ...
  [
    ...
    true,
    88,
    "National Public Digital Infrastructure AI suite powering translation, speech-to-text, and voice bots for 22 scheduled Indian languages.",
    [
      "multi",
      "india",
      "bhashini",
